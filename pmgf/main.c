...
// @version $Id: main.c,v 1.3 2006/03/24 00:58:51 mholst Exp $
// @attention
// @verbatim
//
...
int main(int argc, char **argv) {
  ...
  FILLCO(iparm, rparm, &nx, &ny, &nz, xf, yf, zf, gxcf, gycf, gzcf, a1cf, a2cf,
         a3cf, ccf, fcf, tcf);
  ...
  case 0:
    ...
    CGMGDRIV(iparm, rparm, iwork, rwork, u, xf, yf, zf, gxcf, gycf, gzcf, a1cf,
             a2cf, a3cf, ccf, fcf, tcf);
    break;

  case 1:
    fprintf(stderr, "%% MGMAIN: calling newton (nonlinear) ... \n");
    NEWDRIV(iparm, rparm, iwork, rwork, u, xf, yf, zf, gxcf, gycf, gzcf, a1cf,
            a2cf, a3cf, ccf, fcf, tcf);
    break;

  case 2:
    fprintf(stderr, "%% MGMAIN: calling nmg (linear/nonlinear) ... \n");
    MGDRIV(iparm, rparm, iwork, rwork, u, xf, yf, zf, gxcf, gycf, gzcf, a1cf,
           a2cf, a3cf, ccf, fcf, tcf);
    break;

  case 3:
    fprintf(stderr, "%% MGMAIN: calling ncg (linear/nonlinear) ... \n");
    NCGHSDRIV(iparm, rparm, iwork, rwork, u, xf, yf, zf, gxcf, gycf, gzcf, a1cf,
              a2cf, a3cf, ccf, fcf, tcf);
    break;

  case 4:
    fprintf(stderr, "%% MGMAIN: calling nsor (linear/nonlinear) ... \n");
    NSORDRIV(iparm, rparm, iwork, rwork, u, xf, yf, zf, gxcf, gycf, gzcf, a1cf,
             a2cf, a3cf, ccf, fcf, tcf);
    break;

  case 5:
    fprintf(stderr, "%% MGMAIN: calling ngsrb (linear/nonlinear) ... \n");
    NGSRBDRIV(iparm, rparm, iwork, rwork, u, xf, yf, zf, gxcf, gycf, gzcf, a1cf,
              a2cf, a3cf, ccf, fcf, tcf);
    break;

  case 6:
    fprintf(stderr, "%% MGMAIN: calling nwjac (linear/nonlinear) ... \n");
    NWJACDRIV(iparm, rparm, iwork, rwork, u, xf, yf, zf, gxcf, gycf, gzcf, a1cf,
              a2cf, a3cf, ccf, fcf, tcf);
    break;

  case 7:
    fprintf(stderr, "%% MGMAIN: calling nrich (linear/nonlinear) ... \n");
    NRICHDRIV(iparm, rparm, iwork, rwork, u, xf, yf, zf, gxcf, gycf, gzcf, a1cf,
              a2cf, a3cf, ccf, fcf, tcf);
    break;
  ...
  WRITIT(iparm, rparm, &nx, &ny, &nz, u, xf, yf, zf, gxcf, gycf, gzcf, a1cf,
         a2cf, a3cf, ccf, fcf, tcf, &key);
