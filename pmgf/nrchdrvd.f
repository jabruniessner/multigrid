...
c* @brief   Driver for nonlinear Richardson iteration.
c* @version $Id: nrchdrvd.f,v 1.2 2006/03/24 00:58:51 mholst Exp $
c* @attention
c* @verbatim
c*
...
c*    *** stop timer ***
      ...
      print*,'% NRICHDRIV2: fine problem setup time: ',tsetupf
      tsetupc = 0.0d0
c*
c* ******************************************************************
...
c*    *** stop timer ***
      ...
      print*,'% NRICHDRIV2: solve time: ',tsolve
c*
c*    *** MATLAB ***
