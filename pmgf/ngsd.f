...
c* @brief   Nonlinear Gauss-Seidel iteration.
c* @version $Id: ngsd.f,v 1.2 2006/03/24 00:58:51 mholst Exp $
c* @attention
c* @verbatim
c*
...
c* ///////////////////////////////////////////////////////////////////////////
      ...
      subroutine ngsrb(nx,ny,nz,ipc,rpc,ac,cc,fc,x,w1,w2,r,
...
c*    *** return and end ***
      ...
      subroutine ngsrb7(nx,ny,nz,ipc,rpc,
     2   oC,cc,fc,
     3   oE,oN,uC,
     4   x,w1,w2,r,
     5   itmax,iters,errtol,omega,iresid,iadjoint)
...
c* purpose: 
c*
c*    7 diagonal nonlinear gauss-seidel routine.
c*
...
c* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
c* %%% nonlinear gauss-seidel-newton iteration (ortega-rheinboldt, page 219)
c* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
c*
c* %%% initial guess
c* iters = 0;
...
c*    *** return and end ***
      ...
      subroutine ngsrb27(nx,ny,nz,ipc,rpc,
     2   oC,cc,fc,
...
c* purpose: 
c*
c*    27 diagonal nonlinear gauss-seidel routine.
c*
c*    this routine applies the gauss-seidel operator or its
c*    adjoint depending on the flag iadjoint.
c*
...
c*    *** return and end ***
      ...
      subroutine ngsrb7X(nx,ny,nz,ipc,rpc,
     2   oC,cc,fc,
     3   oE,oN,uC,
     4   x,w1,w2,r,
     5   itmax,iters,errtol,omega,iresid,iadjoint)
...
c* purpose: 
c*
c*    fast 7 diagonal nonlinear red/black gauss-seidel routine.
c*
