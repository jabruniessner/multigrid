...
extern "C" void buildg_1_(
    ...
    DataType *dPNW, DataType *dPSE, DataType *dPSW, DataType *oC, DataType *XoC,
    DataType *XoE, DataType *XoN, DataType *XuC, DataType *XoNE, DataType *XoNW,
    DataType *XuE, DataType *XuW, DataType *XuN, DataType *XuS, DataType *XuNE,
    DataType *XuNW, DataType *XuSE, DataType *XuSW);
...
int main() {
  ...
  buildg_1_(&nxf, &nyf, &nzf, &nxc, &nyc, &nzc, oPC_f, oPN_f, oPS_f, oPE_f,
            oPW_f, oPNE_f, oPNW_f, oPSE_f, oPSW_f, uPC_f, uPN_f, uPS_f, uPE_f,
            uPW_f, uPNE_f, uPNW_f, uPSE_f, uPSW_f, dPC_f, dPN_f, dPS_f, dPE_f,
            dPW_f, dPNE_f, dPNW_f, dPSE_f, dPSW_f, oC, XoC_f, XoE_f, XoN_f,
            XuC_f, XoNE_f, XoNW_f, XuE_f, XuW_f, XuN_f, XuS_f, XuNE_f, XuNW_f,
            XuSE_f, XuSW_f);

  VbuildG_1(&nxf, &nyf, &nzf, &nxc, &nyc, &nzc, oPC_c, oPN_c, oPS_c, oPE_c,
            oPW_c, oPNE_c, oPNW_c, oPSE_c, oPSW_c, uPC_c, uPN_c, uPS_c, uPE_c,
            uPW_c, uPNE_c, uPNW_c, uPSE_c, uPSW_c, dPC_c, dPN_c, dPS_c, dPE_c,
            dPW_c, dPNE_c, dPNW_c, dPSE_c, dPSW_c, oC, XoC_c, XoE_c, XoN_c,
            XuC_c, XoNE_c, XoNW_c, XuE_c, XuW_c, XuN_c, XuS_c, XuNE_c, XuNW_c,
            XuSE_c, XuSW_c, q);
