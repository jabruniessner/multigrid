...
int main() {
  ...
  DataType *oNE = new DataType[nxf * nyf * nzf](); ///< @todo: doc
  DataType *oNW = new DataType[nxf * nyf * nzf](); ///< @todo: doc
  DataType *uE = new DataType[nxf * nyf * nzf]();  ///< @todo: doc
  DataType *uW = new DataType[nxf * nyf * nzf]();  ///< @todo: doc
  DataType *uN = new DataType[nxf * nyf * nzf]();  ///< @todo: doc
  DataType *uS = new DataType[nxf * nyf * nzf]();  ///< @todo: doc
  DataType *uNE = new DataType[nxf * nyf * nzf](); ///< @todo: doc
  DataType *uNW = new DataType[nxf * nyf * nzf](); ///< @todo: doc
  DataType *uSE = new DataType[nxf * nyf * nzf](); ///< @todo: doc
  ...
  buildpb_op27_(&nxf, &nyf, &nzf, &nxc, &nyc, &nzc, nullptr, nullptr, oC, oE,
                oN, uC, oNE, oNW, uE, uW, uN, uS, uNE, uNW, uSE, uSW, oPC_f,
                oPN_f, oPS_f, oPE_f, oPW_f, oPNE_f, oPNW_f, oPSE_f, oPSW_f,
                uPC_f, uPN_f, uPS_f, uPE_f, uPW_f, uPNE_f, uPNW_f, uPSE_f,
                uPSW_f, dPC_f, dPN_f, dPS_f, dPE_f, dPW_f, dPNE_f, dPNW_f,
                dPSE_f, dPSW_f);

  VbuildPb_op27(&nxf, &nyf, &nzf, &nxc, &nyc, &nzc, nullptr, nullptr, oC, oE,
                oN, uC, oNE, oNW, uE, uW, uN, uS, uNE, uNW, uSE, uSW, oPC_c,
                oPN_c, oPS_c, oPE_c, oPW_c, oPNE_c, oPNW_c, oPSE_c, oPSW_c,
                uPC_c, uPN_c, uPS_c, uPE_c, uPW_c, uPNE_c, uPNW_c, uPSE_c,
                uPSW_c, dPC_c, dPN_c, dPS_c, dPE_c, dPW_c, dPNE_c, dPNW_c,
                dPSE_c, dPSW_c, q);
