...
extern "C" void
buildpb_trilin_(int *nxf, int *nyf, int *nzf, int *nxc, int *nyc, int *nzc,
...
int main() {
  ...
  buildpb_trilin_(&nxf, &nyf, &nzf, &nxc, &nyc, &nzc, oPC_f, oPN_f, oPS_f,
                  oPE_f, oPW_f, oPNE_f, oPNW_f, oPSE_f, oPSW_f, uPC_f, uPN_f,
                  uPS_f, uPE_f, uPW_f, uPNE_f, uPNW_f, uPSE_f, uPSW_f, dPC_f,
                  dPN_f, dPS_f, dPE_f, dPW_f, dPNE_f, dPNW_f, dPSE_f, dPSW_f,
                  xf, yf, zf);

  VbuildPb_trilin(&nxf, &nyf, &nzf, &nxc, &nyc, &nzc, oPC_c, oPN_c, oPS_c,
                  oPE_c, oPW_c, oPNE_c, oPNW_c, oPSE_c, oPSW_c, uPC_c, uPN_c,
                  uPS_c, uPE_c, uPW_c, uPNE_c, uPNW_c, uPSE_c, uPSW_c, dPC_c,
                  dPN_c, dPS_c, dPE_c, dPW_c, dPNE_c, dPNW_c, dPSE_c, dPSW_c,
                  xf, yf, zf, q);
