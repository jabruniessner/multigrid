...
int main(int argc, char *argv[]) {
  ...
  //      Multigrid_domain<3, nlev, base_length, base_length,
  //      base_length>::length;
  //
  ...
  //
  //      boundary_values.set_value((double)i / (double)(std::get<2>(length) +
  //      1),
  //                                0, j, i);
  //
  //      boundary_values.set_value((double)i / (double)(std::get<2>(length) +
  ...
  //                      anyways
  //
  //  Multi_Level_operator diff_operator(Integer<nlev>{}, values_op,
  //  offsets_op, 1.,
  //                                     Integer<base_length>{});
  //
