...
//       co_yield std::ranges::elements_of(finding_edge_points_helper(
//           sphere, grid_step,
//           std::make_index_sequence<sizeof...(directions) + 1>{},
//           positions..., i));
//     }
//   }
// }
...
//     const auto sqrt = std::sqrt(sqrt_squared);
//
//     const int lower_bound = std::ceil((current_value - sqrt) / grid_step -
//     .5); const int upper_bound = std::floor((current_value + sqrt) /
//     grid_step - .5);
//
//     for (int i = lower_bound; i <= upper_bound; i++) {
//       co_yield std::ranges::elements_of(finding_edge_cubes_helper(
...
//           Length... directions>
// void cutting_cubes_helper(Cutter cutter,
//                           domain::Grid<Tet_type, Dim, DomainSize...>
//                           &tet_grid, Sphere<DataType, Dim> &sphere, DataType
//                           grid_step, std::index_sequence<directions...>,
//                           Positions... positions) {
//
//   constexpr DataType sqrt_Dim = const_sqrt(static_cast<DataType>(Dim)) * 0.5;
...
//         //
//         cutter(tet_grid, sphere.Position, sphere.radius, grid_step,
//                positions..., i);
//       }
//     } else if (sqrt_squared_inner > 0) {
//
...
// }
//
// template <typename Cutter, typename DataType, typename Tet_type, Dimension
// Dim,
//           Length... DomainSize>
// void cutting_cubes(Cutter cutter,
//                    domain::Grid<Tet_type, Dim, DomainSize...> tet_grid,
//                    Sphere<DataType, Dim> &sphere, const DataType grid_step) {
